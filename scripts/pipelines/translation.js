...
var input_path = path.join(__dirname, "../../products/virtual-maths-camp/development/vmc-master.json");
...
//output_path = path.join(__dirname, "../../products/covid-19-parenting/development/translation/eng/intermediary-files/current_flows/current_step_2_file_for_transl_activities.json");
